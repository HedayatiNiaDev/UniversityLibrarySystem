<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="UniversityLibrarySystem.Register" %>
...
<head runat="server">
    <title><%=Classes.SiteConfig.mixTitle("ثبت نام") %></title>
    ...
    <main class="login-bg">
        ...
        <form runat="server">
            <div class="register-form-area">
                <div class="register-form mb-1">
                    <div class="register-heading">
                        <a href="/">
                            <img src="img/logo/logo.png" alt="<%=Classes.SiteConfig.getSiteName() %>" />
                        </a>
                        <span>ثبت نام</span>
                        <p>برای دسترسی به سامانه ثبت نام کنید</p>
                        <asp:Label ID="SuccessMessage" runat="server" CssClass="text-success" Visible="false" Text="ثبت نام شما با موفقیت انجام شد" Font-Size="12"></asp:Label>
                    ...
                    <div class="input-box">
                        ...
                        <div class="single-input-fields">
                            <asp:Label ID="FullNameLabel" runat="server" AssociatedControlID="FullName">نام و نام خانوادگی</asp:Label>
                            <asp:TextBox ID="FullName" runat="server" CssClass="form-control" placeholder="نام و نام خانوادگی"></asp:TextBox>
                        ...
                        <!-- نام کاربری -->
                        <div class="single-input-fields">
                            <asp:Label ID="Label2" runat="server" AssociatedControlID="Username">نام کاربری</asp:Label>
                            <asp:TextBox ID="Username" runat="server" CssClass="form-control" placeholder="نام کاربری"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Username" ErrorMessage="نام کاربری الزامی است" Display="Dynamic" CssClass="text-danger"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="Username" ErrorMessage="نام کاربری باید فقط شامل اعداد باشد" ValidationExpression="^\d+$" Display="Dynamic" CssClass="text-danger"></asp:RegularExpressionValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="Username" ErrorMessage="تعداد کارکتر های مجاز بیشتر از حد مجاز است" ValidationExpression="^.{1,50}$" Display="Dynamic" CssClass="text-danger"></asp:RegularExpressionValidator>

                        </div>

                        <!-- رمز عبور -->
                        <div class="single-input-fields">
                            <asp:Label ID="Label3" runat="server" AssociatedControlID="Password">رمز عبور</asp:Label>
                            <asp:TextBox ID="Password" runat="server" TextMode="Password" CssClass="form-control" placeholder="رمز عبور"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="Password" ErrorMessage="رمز عبور الزامی است" Display="Dynamic" CssClass="text-danger"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="Password" ValidationExpression="^[A-Za-z\d@$!%*?&]{8,}$" ErrorMessage="رمز عبور باید حداقل ۸ کاراکتر باشد و می‌تواند شامل حروف لاتین یا اعداد باشد" Display="Dynamic" CssClass="text-danger"></asp:RegularExpressionValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="Password" ErrorMessage="تعداد کارکتر های مجاز بیشتر از حد مجاز است" ValidationExpression="^.{1,50}$" Display="Dynamic" CssClass="text-danger"></asp:RegularExpressionValidator>

                        </div>

                        <!-- شماره موبایل -->
                        <div class="single-input-fields">
                            <asp:Label ID="MobileLabel" runat="server" AssociatedControlID="Mobile">شماره موبایل</asp:Label>
                            <asp:TextBox ID="Mobile" runat="server" CssClass="form-control" placeholder="شماره موبایل"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvMobile" runat="server" ControlToValidate="Mobile" ErrorMessage="شماره موبایل الزامی است" Display="Dynamic" CssClass="text-danger"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="revMobile" runat="server" ControlToValidate="Mobile" ErrorMessage="شماره موبایل معتبر نیست" ValidationExpression="09(0(\d)|1(\d)|2(\d)|3(\d)|(9(\d)))\d{7}$" Display="Dynamic" CssClass="text-danger"></asp:RegularExpressionValidator>
                        </div>
                        ...
                        <div class="single-input-fields">
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ControlToValidate="CaptchaCodeTextBox" ErrorMessage="تعداد کارکتر های مجاز بیشتر از حد مجاز است" ValidationExpression="^.{1,10}$"
                    ...
                    <div class="register-footer">
                        ...
                        <asp:Button ID="RegisterButton" runat="server" Text="ثبت نام" CssClass="submit-btn3" OnClick="RegisterButton_Click" />
                    </div>
