<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Students.ascx.cs" Inherits="UniversityLibrarySystem.Manager.Students" %>
<style>
    #<%=ImageNopic.ClientID %> {
...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 breadcrumb-wrapper mb-4">مدیریت دانشجویان
        </h4>
        <div class="mb-0">
                                            ...
                                            <tr>
                                                <td>
                                                    <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                                        ...
                                                        <a style="color: #000;" href="./<%# Eval("isAdmin")%>?Edit=<%# ID2hash(Eval("UserID"))%>"><%#Eval("NameFamily")%></a>
                                                    </ul>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="./Students?Edit=<%# ID2hash(Eval("ID"))%>"><i class="bx bx-edit-alt me-1"></i>ویرایش</a>
                                                            <a class="dropdown-item" href="./Students?Reset=<%# ID2hash(Eval("ID"))%>"><i class="bx bx-lock-open-alt me-1"></i>لغو قفل حساب کاربری</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="pt-4">
                                        ...
                                        <a href="./Students" class="btn btn-label-secondary">بازگشت</a>
                                    </div>
                                </div>
                            </div>
                        </div>
